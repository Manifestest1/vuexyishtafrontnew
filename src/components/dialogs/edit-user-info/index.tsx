...
// import { userUpdateProfile } from '@/context/api/apiService'
...
type EditUserInfoProps = {
  ...
  updateUserDataFun: (formData: FormData) => void
}
...
const EditUserInfo = ({ open, setOpen, updateUserDataFun, data, getuserData, updateuserData }: EditUserInfoProps) => {
  // States
  const [userData, setUserData] = useState<EditUserInfoProps['data']>(data || initialData)

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    updateUserDataFun({ name: getuserData.name })
    setOpen(false)
  }
