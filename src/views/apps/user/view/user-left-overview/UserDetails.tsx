...
import { getAuthUserData, userUpdateProfile } from '@/context/api/apiService'
...
const UserDetails = () => {
  ...
  const [getuserData, updateuserData] = useState({ name: '' })
  ...
  const handleupdateUserDataFun = formData => {
    userUpdateProfile(formData).then(response => {
      getAuthUserDataFun()
          ...
          <div className='flex flex-col gap-6'>
            <div className='flex items-center justify-center flex-col gap-4'>
              <div className='flex flex-col items-center gap-4'>
                ...
                {/* <Typography variant='h5'>{`${getuserData?.name} ${userData.lastName}`}</Typography> */}
                <Typography variant='h5'>{`${getuserData?.name}`}</Typography>
              </div>
          ...
          <div className='flex gap-4 justify-center'>
            <OpenDialogOnElementClick
              ...
              dialogProps={{
                ...
                updateUserDataFun: handleupdateUserDataFun
              }}
            />
            {/* <OpenDialogOnElementClick
              element={Button}
